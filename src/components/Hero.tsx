...
export const Hero: React.FC = () => {
  ...
  return (
    <section id="overview" className="relative py-16 sm:py-24 bg-[#14161A] border-b border-gray-800/60 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#22D3EE_1px,transparent_1px)] [background-size:24px_24px] opacity-10 pointer-events-none"></div>
      <div className="absolute -top-32 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-[#22D3EE]/10 blur-[120px] rounded-full pointer-events-none"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          {/* Left Column: Product Information & CTAs (7 cols) */}
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            
            {/* Version & System Baseline Badge */}
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#1D2026] border border-gray-800 text-xs font-mono shadow-inner">
            ...
            {/* Subtitle - Exact Suggested Positioning */}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4">
              <a
                href="#downloads"
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-[#22D3EE] hover:bg-[#06B6D4] text-[#14161A] font-extrabold text-sm transition-all shadow-xl shadow-[#22D3EE]/25 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-[#22D3EE]"
              >
                <svg className="w-5 h-5 text-[#14161A]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                </svg>
                <span>Get Free Download (.dmg)</span>
              </a>

              <a
                href="#routing-visualizer"
                className="w-full sm:w-auto px-7 py-4 rounded-xl bg-[#1D2026] hover:bg-gray-800 text-white font-bold text-sm border border-gray-800 hover:border-gray-700 transition-all flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-[#22D3EE]"
              >
          ...
          {/* Right Column: Verified Product Enclosure Preview (5 cols) */}
            ...
            <div className="p-6 rounded-3xl bg-[#1D2026] border border-gray-800 shadow-2xl space-y-5 relative overflow-hidden group hover:border-[#22D3EE]/40 transition-all">
              ...
              <div className="grid grid-cols-4 gap-3 text-center">
                <div className="p-3 rounded-xl bg-[#14161A] border border-gray-800 space-y-1">
                  ...
                  <div className="w-9 h-9 mx-auto rounded-full border-2 border-[#22D3EE] flex items-center justify-center text-[10px] font-bold text-[#22D3EE] bg-[#22D3EE]/10">
                    1/4
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-[#14161A] border border-gray-800 space-y-1">
                  ...
                  <div className="w-9 h-9 mx-auto rounded-full border-2 border-[#F5A524] flex items-center justify-center text-[10px] font-bold text-[#F5A524] bg-[#F5A524]/10">
                    1/8D
                  </div>
                </div>
                ...
                <div className="p-3 rounded-xl bg-[#14161A] border border-gray-800 space-y-1">
                  ...
                  <div className="w-9 h-9 mx-auto rounded-full border-2 border-gray-700 flex items-center justify-center text-[10px] font-bold text-gray-400 bg-gray-800/40">
                    OFF
                  </div>
                </div>
              </div>

              {/* Animated Waveform / Signal Path Simulation */}
              <div className="p-4 rounded-2xl bg-[#14161A] border border-gray-800 space-y-2 relative overflow-hidden">
                ...
                {/* L / R Signal Animation Lines */}
                <div className="space-y-2 py-1">
                  <div className="h-2 rounded-full bg-gray-800 relative overflow-hidden">
                    <div
                      className="absolute top-0 bottom-0 w-12 bg-gradient-to-r from-transparent via-[#22D3EE] to-transparent rounded-full shadow-[0_0_12px_#22D3EE]"
                      style={{ left: `${pulsePos}%` }}
                    ></div>
                  </div>
                  ...
                  <div className="h-2 rounded-full bg-gray-800 relative overflow-hidden">
                    <div
                      className="absolute top-0 bottom-0 w-12 bg-gradient-to-r from-transparent via-[#F5A524] to-transparent rounded-full shadow-[0_0_12px_#F5A524]"
                      style={{ left: `${(pulsePos + 50) % 100}%` }}
                    ></div>
                  </div>
                </div>
        ...
        {/* Bottom Verified Technical Specifications Bar */}
