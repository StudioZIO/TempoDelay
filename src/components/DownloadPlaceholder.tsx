          ...
          <div className="p-8 rounded-3xl bg-[#1D2026] border border-gray-700/80 hover:border-[#22D3EE]/50 transition-all shadow-2xl flex flex-col justify-between space-y-6">
            ...
            <div className="space-y-3 pt-4 border-t border-gray-800">
              ...
              <button
                ...
                className="w-full py-4 px-6 rounded-xl bg-[#22D3EE] hover:bg-[#06B6D4] text-[#14161A] font-extrabold text-sm transition-all shadow-xl shadow-[#22D3EE]/25 flex items-center justify-center space-x-2 focus:outline-none focus:ring-2 focus:ring-[#22D3EE] cursor-pointer"
